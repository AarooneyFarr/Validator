...
export default async function DashboardPage({ params, children }: { params: { id: string }; children: ReactNode }) {
    ...
    const secondaryNavigation = [
        ...
        { name: 'Contacts', href: '/site/' + params.id, current: false },
        { name: 'View site', href: '/site/' + params.id + '/settings/appearance', current: true },
    ]
